...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://owrites.co/images/og-owrites-tarifs.jpg", width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Tarifs Ghostwriting LinkedIn & Lead Generation B2B — Owrites",
    description: "Ghostwriting LinkedIn dès 297€/mois. Packages clairs pour fondateurs et consultants B2B.",
    images: ["https://owrites.co/images/og-owrites-tarifs.jpg"],
  },
  alternates: {
    canonical: "https://owrites.co/tarifs",
    languages: { fr: "https://owrites.co/tarifs" },
  },
};
